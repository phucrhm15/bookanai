export const en = {
  ...
  arcTools: {
    ...
    subtitle:
      "Claim testnet USDC, bridge via CCTP, swap stablecoins, and explore Arc DeFi — gas paid in USDC, no ETH required.",
    testnetBadge: "Testnet",
    arcBalance: "Arc on-chain",
    usdcGas: "USDC native gas",
    tabFaucet: "Faucet",
    tabBridge: "Bridge",
    tabSwap: "Swap",
    tabDefi: "DeFi & Tools",
    faucetHelp:
      "Arc uses USDC for gas — claim free testnet USDC from Circle's faucet, then bridge, swap, or run agents on Arc Testnet.",
    faucetStep1: "Copy your embedded wallet address below.",
    faucetStep2: "Open Circle Faucet → select Arc Testnet → paste address → claim USDC.",
    faucetStep3: "Return here — balance updates in ~30s. Use Bridge tab to move USDC cross-chain.",
    openFaucet: "Open Circle Faucet",
    addNetwork: "Add Arc to MetaMask",
    noWalletExtension: "No browser wallet found (MetaMask, Rabby, etc.).",
    networkAdded: "Arc Testnet added to your wallet.",
    networkAddFailed: "Could not add Arc Testnet network.",
    bridgeHelp:
      "Bridge USDC between Arc Testnet and other Circle-supported chains (CCTP). Same wallet address on both sides.",
    depositHelp:
      "After faucet USDC lands on Arc, deposit into Circle Gateway to sync Content Credits (optional).",
    depositArc: "Deposit Arc USDC → Gateway",
    runBridge: "Bridge USDC (CCTP)",
    swapHelp: "Same-chain stablecoin swap on Arc Testnet via Circle App Kit (USDC ↔ EURC).",
    runSwap: "Swap on Arc",
    defiHelp: "Official Arc ecosystem tools — explorer, docs, CCTP guides, and Circle developer kits.",
    needFaucetFirst: "Not enough USDC on Arc — use the Faucet tab first.",
    toolFaucet: "Circle Faucet",
    toolFaucetDesc: "Free testnet USDC for Arc, Base Sepolia, and more.",
    toolExplorer: "Arcscan Explorer",
    toolExplorerDesc: "Browse transactions, contracts, and wallet activity on Arc Testnet.",
    toolCctp: "CCTP Bridge Guide",
    toolCctpDesc: "Burn-and-mint USDC across chains — Arc domain 26.",
    toolDocs: "Arc Documentation",
    toolDocsDesc: "Network specs, RPC endpoints, and integration guides.",
    toolDeploy: "Deploy on Arc",
